...
export const iconButtonStyles = cva(
  [
    "box-border inline-flex shrink-0 select-none items-center justify-center",
    "data-[disabled=true]:cursor-not-allowed data-[disabled=true]:filter-none",
    "data-[disabled=true]:bg-disabled data-[disabled=true]:text-fgdisabled",
  ],
  {
    variants: {
      size: {
      ...
      variant: {
        solid: [
          ...
          "data-[active=true]:brightness-110 data-[active=true]:saturate-[1.1] dark:data-[active=true]:brightness-[1.08]",
    ...
    compoundVariants: [
      // solid
      {
        ...
        className: [
          ...
          "font-medium text-primary-contrast",
          "data-[active=true]:brightness-110 data-[active=true]:saturate-[1.1] dark:data-[active=true]:brightness-[1.08]",
          "focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2",
        ],
      },
      {
        ...
        className: [
          ...
          "font-medium text-secondary-contrast",
          "data-[active=true]:brightness-110 data-[active=true]:saturate-[1.1] dark:data-[active=true]:brightness-[1.08]",
          "focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2",
        ],
      },
      ...
      // },
      {
        ...
        className: [
          ...
          "font-medium text-destructive-contrast",
          "data-[active=true]:brightness-110 data-[active=true]:saturate-[1.1] dark:data-[active=true]:brightness-[1.08]",
          "focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2",
        ],
      },
