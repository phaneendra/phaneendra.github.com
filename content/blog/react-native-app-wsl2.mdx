---
title: Building a react native app in WSL2
publishedDate: '2016-03-08'
lastUpdatedDate: '2016-03-08'
author: phaneendra
tags: ['npm', 'nodejs', 'code', 'features']
status: published
description: How to safely upgrade the npm dependencies
---
...
- [Building a react native app in WSL2](#building-a-react-native-app-in-wsl2)
