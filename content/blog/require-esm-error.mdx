---
title: 'Error \[ERR_REQUIRE_ESM\]: require() not supported'
publishedDate: '2017-07-15'
lastUpdatedDate: '2016-03-08'
author: phaneendra
tags: ['js', 'esm', 'error']
status: published
description: 'Error occurs because a package you are importing has been converted to be an ESM only package, which means that the package cannot be imported with `require()` anymore'
---
