...
```jsx
import PageTitle from './app/components/widgets/Page-Title.tsx';
...
tags: ['next-js', 'tailwind', 'guide']
status: published
description: 'Introducing the new layout features - you can map mdx blog content to layout components by configuring the frontmatter field'
layout: PostSimple
---
```
