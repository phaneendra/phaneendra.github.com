...
status: published
description: How to use ::before and ::after in Tailwind CSS
---
...
```html
<div
  class="before:absolute before:bg-blue-500 after:flex after:bg-blue-300"
></div>
```
...
<div
  before="hello world"
  class="before:block before:content-[attr(before)] ..."
></div>
```
